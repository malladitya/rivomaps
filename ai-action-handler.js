...
function handleScrollToReportZone(data) {
  console.log('🎯 Scrolling to report zone section with data:', data);
  ...
  if (reportSection) {
    ...
    if (window.showNotification) {
      setTimeout(() => {
        window.showNotification('🎯 Report zone section highlighted! Fill out the form to submit your report.', 'info');
      }, 1000);
    }
  } else {
    console.warn('⚠️ Report zone section not found');
    if (window.showNotification) {
