...
const config = {
  geminiApiKey: 'AIzaSyAUoiuiLtQpIMfNkHeJYBHi_71isxz7ke8', // Replace with your actual Gemini API key
...
if (config.geminiApiKey === 'AIzaSyAUoiuiLtQpIMfNkHeJYBHi_71isxz7ke8') {
